                  ...
                  {user.isAuthenticated ? (
                    <div className="flex items-center mt-4 md:mt-0">
                      ...
                      <div className="relative inline-block ">
                        ...
                        {showMenu && (
                          <div
                            className="absolute right-0 z-20 w-60 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800"
                    ...
                    <div className="flex items-center mt-4 md:mt-0">
                      ...
                      <div className="relative inline-block">
                        <Link
                          className="flex items-center ml-2 px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-80"
                          to="/register"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
